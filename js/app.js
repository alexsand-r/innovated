(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && (window.innerWidth < 450 && e.target.closest(".header__button") || e.target.closest(".icon-menu"))) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-open");
            } else if (e.target.closest("header a")) {
                const gotoTarget = e.target.closest("header a").getAttribute("href");
                if (gotoTarget && gotoTarget.startsWith("#")) {
                    e.preventDefault();
                    const targetElement = document.querySelector(gotoTarget);
                    if (targetElement) {
    ...
    function initSliders() {
        if (document.querySelector(".swiperuor__slider")) new core(".swiperuor__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
